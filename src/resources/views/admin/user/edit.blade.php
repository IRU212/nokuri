        ...
        <div class="container-fluid py-2">
            <div class="ms-3">
                ...
                <form action="" method="post">
                    ...
                    <x-common.form.input_email class="input-group input-group-outline mb-4" name="email" label="メールアドレス" value="{{ $user->email }}" />
                    <x-common.form.input_password class="input-group input-group-outline mb-4" name="password" label="パスワード" />
